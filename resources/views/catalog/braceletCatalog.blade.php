        ...
        <div class="categoryName">
            <ul class="row">
                <li class="col-lg-3 col-md-3 col-sm-3 col-xs-3 ">
                    <a href="ringCatalog"><h6><i class="fa fa-caret-left" ></i>КОЛЬЦА</h6>
                    </a>
                </li>
                ...
                <li class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                    <a href="necklacesCatalog"><h6>ОЖЕРЕЛЬЕ<i class="fa fa-caret-right" ></i></h6></a>
        ...
        <div class="item col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-10 col-xs-10">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <img class="popup_img" src="../uploads/bracelets/{{$item->bracelet_name}}">
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="price col-lg-7 col-md-7 col-sm-8 col-xs-8"><p>Цена:</p>{{$item->bracelet_price}}</div>
                        ...
                        @if(Auth::check() && Auth::user()->is_admin == 1)
                            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <a href="{{url('/braceletCatalog/'.$item->bracelet_id.'/edit')}}">
                                    <button class="btnedit btn btn-primary btn-success">Редактировать</button>
                                </a>
                            </div>
                        @endif
                        @if(Auth::check() && Auth::user()->is_admin == 1)
